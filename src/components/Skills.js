        ...
        <div className="columns">
          <div className="column" data-aos="fade-right" data-aos-mirror="true">
            <div className="container">
              ...
              <br />
              <h2 class="subtitle">I've been developing stuff since 2017.</h2>
            </div>
          </div>
              ...
              <div class="tile is-ancestor">
                <div class="tile is-vertical is-parent">
                  <div class="tile is-child notification has-shadow is-white">
                    ...
                    <p className="is-size-5"> I create apps and sites.</p>
                    <br />
                    <span class="title is-size-4">Languages I Speak</span>
                    <br />
                    {LANGUAGES.map(item => (
                      <>
                    ...
                    <br />
                    <br />
                    <span class="title is-size-4">Tools I Use</span>
                    <br />
                    {TOOLS.map(item => (
                      <>
                        <span class="tag is-light">{item}</span>{" "}
